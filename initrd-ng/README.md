...
2. Replace Huffman with [tANS](https://en.wikipedia.org/wiki/Asymmetric_numeral_systems#Tabled_variant_(tANS)). This would save us about 1% in compressed data, at the cost of embedding more metadata and losing out on JIT.
